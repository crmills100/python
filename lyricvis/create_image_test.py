...
class CreateImageTest(unittest.TestCase):
    ...
    def test_create_image_sd(self):
        create_image_sd.create_image(SIZE_VGA, "'Cause then you really might know what it's like to sing the blues", True, "Produced By: Christopher Mills", FONTSIZE, IMAGE_ROOT_PATH + "A_01.png")
